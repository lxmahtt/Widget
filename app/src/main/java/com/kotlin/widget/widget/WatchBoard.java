...
public class WatchBoard extends View {
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        mHourPointWidth = typedArray.getDimension(R.styleable.WatchBoard_wb_hour_pointer_width, Dp2Px(5));
        mMinutePointWidth = typedArray.getDimension(R.styleable.WatchBoard_wb_minute_pointer_width, Dp2Px(3));
        mSecondPointWidth = typedArray.getDimension(R.styleable.WatchBoard_wb_second_pointer_width, Dp2Px(2));
        mPointRadius = typedArray.getDimension(R.styleable.WatchBoard_wb_pointer_corner_radius, Dp2Px(10));
        mPointEndLength = typedArray.getDimension(R.styleable.WatchBoard_wb_pointer_end_length, Dp2Px(10));
    ...
    private void printPointer(Canvas canvas) {
        ...
        RectF rectSecond = new RectF(width / 2 - mSecondPointWidth / 2, width / 2 - mRadius + Dp2Px(10), width / 2 + mSecondPointWidth / 2, width / 2 + mPointEndLength);
    ...
    private void printScale(Canvas canvas) {
        ...
        for (int i = 0; i < 60; i++) {
            if (i % 5 == 0) {
                ...
                canvas.drawText(text, width / 2 - textBound.width() / 2, textBound.height() + Dp2Px(5) + lineWidth + mPadding, mPaint);
